...
const Hero = () => {
  ...
  return (
    <div className="hero-container" style={{ padding: "20px" }}>
      ...
      <header className="hero-header" style={{ textAlign: "center", marginBottom: "30px" }}>
        <h1>Authenticator for Academic Certificates</h1>
        <p>Verification made easy and secure</p>
      </header>
      ...
      >
        <p><strong>Bulk Certificates</strong></p>
      ...
      {/* File List */}
      {files.length > 0 && (
        <div className="file-list" style={{ maxWidth: "600px", margin: "20px auto" }}>
          <ul style={{ listStyle: "none", padding: 0 }}>
            {files.map((file, index) => (
              ...
              >
                <span>{file.name}</span>
                <FiTrash2 style={{ cursor: "pointer" }} onClick={() => removeFile(index)} />
              </li>
            ))}
          </ul>
        </div>
